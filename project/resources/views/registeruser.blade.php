                ...
                <div class="container">
                    ...
                    <form action="{{route('user.reg.submit')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <button type="submit" id="RegButton" class="btn btn-ocean"><strong>Register</strong></button>
                            </div>
                        </div>
                        <div class="form-group login">
                            <div class="col-xs-12 col-md-6 col-md-offset-3" style="padding:0;margin-top: 10px;">
                                <a href="{{route('user.login')}}" class="col-md-6 col-md-offset-3">Already Have Account? Login</a>
                            </div>
                        </div>
                    </form>
                </div>
