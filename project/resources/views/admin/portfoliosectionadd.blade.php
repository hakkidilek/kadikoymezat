                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('PortfolioController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Gallery Images<span class="required">*</span>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button type="submit" class="btn btn-success btn-block">Add Gallery</button>
                                </div>
                            </div>
                        </form>
                    </div>
