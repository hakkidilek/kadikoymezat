                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                <li class="active"><a href="#sectioncontent" data-toggle="tab" aria-expanded="false"><strong>Gallery Section Content</strong></a>
                                <li><a href="#sectiontitle" data-toggle="tab" aria-expanded="true"><strong>Gallery  Section Title</strong></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-xs-12" style="padding: 0">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="sectiontitle">
                                    <div class="go-title">
                                        <h3>Gallery Section Title Text</h3>
                                        <div class="go-line"></div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <form method="POST" action="portfolio/titles" class="form-horizontal form-label-left" id="website_form">
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Gallery Secttion Title <span class="required">*</span>
                                                    </label>
                                                ...
                                                <div class="item form-group">
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Gallery Secttion Text <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="tab-pane active" id="sectioncontent">
                                    <div class="go-title">
                                        <div class="pull-right">
                                            <a href="{!! url('admin/portfolio/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add Gallery Image</a>
                                        </div>
